...
public class Goodadd_Burger extends JFrame {
	public Goodadd_Burger() {
		setTitle("버거(단품) 메뉴추가");
		setLocation(370, 200); // 화면을 중간에 넣게 해줄 수 있는 코드
		...
		btn1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					fout = new FileOutputStream("src/KioskAll/burger.txt", true);
					fout.write(buffer);
					fout.write(' ');
					fout.write(buffer2);
					fout.write('\n');
